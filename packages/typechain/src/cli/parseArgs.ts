...
export function parseArgs(): ParsedArgs {
  const rawOptions = commandLineArgs<CommandLineArgs>(
    {
      ...
      'skip-empty-abis': {
        type: Boolean,
        defaultValue: true,
        description: `Contracts without public method won't be generated by default, this option forces to always generate them.`,
      },
  ...
  return {
    ...
    flags: {
      ...
      skipEmptyAbis: rawOptions['ts-nocheck'],
    },
  }
}
